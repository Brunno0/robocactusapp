                      ...
                      <p>O programa que utilizaremos para desenvolver nossos códigos é um Ambiente de Desenvolvimento Integrado (IDE, na sigla em inglês). Ele foi projetado especificamente para compilar e enviar códigos para a placa Arduino. O software está disponível gratuitamente no site oficial da plataforma: <p> <a href="https://www.arduino.cc/en/software" target="_blank">https://www.arduino.cc/en/software</a> </p> Para começar, basta selecionar a versão compatível com o seu sistema operacional, fazer o download e realizar a instalação.</p><p>A linguagem de programação utilizada na plataforma Arduino é baseada em C++, com a inclusão de bibliotecas e funções específicas para facilitar o desenvolvimento de projetos. No ambiente Arduino, os projetos são chamados de <i>sketches</i>. A seguir, vamos explorar esse ambiente. Após a instalação do programa você encontrará a seguinte interface:</p>
                        ...
                        <TableComponents
                            ...
                            txt1={<Text fontSize="lg" textAlign="justify">
                              ...
                              <HighlightText 
                              letter="N" 
                              text="Menu principal - A barra de menu da IDE conta com uma série de funções importantes como importar códigos de exemplo na aba Arquivos, ou ainda configurar a porta COM de conexão Arduino/computador na aba Ferramentas, entre outras." />


                              <HighlightText 
                              letter="O" 
                              text="Verificar/compilar-Essa função é responsável por compilar o código, verificando possíveis erros de sintaxe, semântica e estrutura. Ela analisa se o código está escrito corretamente, identifica a ausência de sinais ou caracteres necessários e aponta falhas que possam comprometer o funcionamento do projeto." />

                              <HighlightText 
                              letter="P" 
                              text="Enviar para placa - Após verificar seu Sketch é com esse botão que embarcamos o código na placa" />

                              
                              <HighlightText 
                              letter="Q" 
                              text= {"Novo Sketch- Cria um novo projeto"}></HighlightText>

                              <HighlightText 
                              letter="R" 
                              text= "Setup: Quando a plataforma é iniciada, a primeira função executada pelo Arduino é o setup(). Nela, são configuradas as portas, bibliotecas, variáveis e todos os parâmetros necessários para o funcionamento do programa. Essa função é executada apenas uma vez, seja ao ligar a placa ou ao resetá-la."/>

                               <HighlightText 
                              letter="S" 
                              text= "Loop: Após a execução do setup(), a função loop() é chamada. Ela é o núcleo principal do código, onde são programadas as ações e comportamentos dos projetos robóticos. Uma vez que o código é carregado na placa, essa função entra em um ciclo infinito, repetindo os comandos de forma contínua enquanto a placa estiver ligada. "/>
                              ...
                              <HighlightText 
                              letter="U" 
                              text= "Abrir Sketch: Essa função permite abrir um sketch salvo no seu computador ou em um dispositivo de armazenamento externo, como um pendrive ou HD externo. É útil para acessar projetos anteriores ou continuar trabalhos já iniciados."/>
