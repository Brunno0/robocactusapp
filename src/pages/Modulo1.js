...
import { Avatar, Badge, Button, Collapse, Flex, SimpleGrid, SkeletonCircle, SkeletonText, Stack, useBreakpointValue, useDisclosure } from '@chakra-ui/react';
                        ...
                        <AccordionItem >
                            ...
                            <AccordionPanel pb={4}>
                                ...
                                <Highlight textAlign="justify" query={
                                    ['ciência da computação', 'mecânica', 'eletrônica', 'cadeia cinemática', 'sensores', 'autonomia', 'indústria', 'medicina', 'segurança', 'hardware', 'software']} styles={{
                                        px: ['1', '2', '3'],
                                        py: ['0.5', '1', '1.5'],
                                        rounded: 'full',
                                        bg: 'teal.100',
                            ...
                            {({ isExpanded }) => (
                                <>
                                    ...
                                    <AccordionPanel pb={4}>
                                        ...
                                        <SimpleGrid spacing={4} maxW={isMobile ? '100%' : '80%'} templateColumns={isMobile ? 'none' : 'repeat(auto-fill, minmax(30%, 1fr))'}>
                                            <Card>
                                                <CardHeader>
                                        ...
                                        <Text>
                                            ...
                                            Com isso em mente, Isaac Asimov em seu livro de 1950 "I Robot" criou a lógica da proteção humana que deve ser aplicada na robótica e na inteligência artificial, ou seja, as leis das 3 leis da robótica. São elas:
                                            <br/>
